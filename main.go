...
func init() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/stately-lambda-469721-p8:us-central1:mypostgres sslmode=disable port = 5432"
...
func GetTaxiTrips(db *sql.DB) {
	...
	geocoder.ApiKey = "AIzaSyB6kQPrJsR_naGJ6KPUwd2iS3kpg_dQX8U"
